...
----
public  class  Entity  extends  Process
{
    public void Interrupt (Entity toInterrupt, boolean immediate) throws SimulationException, RestartException;
    ...
    protected void waitFor (Entity controller, boolean reAct) throws SimulationException, RestartException, InterruptedException;
    protected void waitFor (Entity controller) throws SimulationException, RestartException, InterruptedException;
